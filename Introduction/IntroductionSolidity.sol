...
/* 
    ...
    Private: Significa que essa função só pode ser chamado pelo nosso código de contrato. Usamos esse tipo quando criarmos 
    uma função auxiliar somente para um código.
